...
def train(net2, optimizer, scheduler, epochs, encrypted_points, inlet_points, outlet_points, bd1_points, bd2_points, train_path, cfd_path, mean_vals, his_freq, batch_size):
    ...
    for epoch in range(epochs):
        ...
        for i in range(num_batches):
            ...
            T_loss = pde_loss_helmholtz(net2, batch_points, Q_func=gaussian_source)
            loss_pde = T_loss

            inlet_loss, outlet_loss = inlet_outlet_loss_helmholtz(net2, inlet_points, outlet_points)
            bd1_loss, bd2_loss = boundary_loss_helmholtz(net2, bd1_points, bd2_points, T_bd1, T_bd2)
