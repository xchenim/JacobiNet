...
from config import L, W, T_non, fttype, ftsize, data_path, cfd_path, train_path, net2_path, v_max, vmax_error, plt_x, plt_y
from data_loader import load_cfd_data, load_train_data, save_history_data
from models_Poisson import Net_poisson
