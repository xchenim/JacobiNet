...
import os
from config import L, W, T_non, fttype, ftsize, data_path, cfd_path, train_path, net3_path, v_max, vmax_error, plt_x, plt_y, post_path
from data_loader import load_cfd_data, load_train_data, save_history_data, load_origin_data
from models_laplace import HybridNet
...
if __name__ == "__main__":
    ...
    all_xy, encrypted_xy, inlet_xy, outlet_xy, bd1_xy, bd2_xy, mean_vals_xy, min_vals_xy, max_vals_xy, train_df_xy = load_origin_data(post_path)
