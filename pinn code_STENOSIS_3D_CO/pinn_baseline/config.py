...
data_path = str(DATA_DIR / "stenosis.xlsx")
post_path = str(DATA_DIR / "stenosis_post.xlsx")
save_path = str(HISTORY_DIR / "training_history_baseline.csv")
net2_path = str(PARAM_DIR / "pinn_baseline.pth")
net2_u_path = net2_path
