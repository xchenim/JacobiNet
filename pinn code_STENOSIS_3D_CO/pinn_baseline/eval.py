...
import numpy as np
import torch
from config import L, R, U_non, P_non, inlet_vel
from utils import compute_normal_vector, parabolic_velocity

device = torch.device("cuda:0")
def compute_l2_error(net2, x_cfd, y_cfd, z_cfd, u_cfd, v_cfd, w_cfd, p_cfd, mean_vals):
    net2.eval()
